...
public class QRCodeDecodeController4ARfoundation : MonoBehaviour
{
	...
	public ARfoundationCamera4QRCode e_DeviceController = null; 
	...
	void Start()
	{
        ...
        if (!e_DeviceController) {
			e_DeviceController = GameObject.FindObjectOfType<ARfoundationCamera4QRCode>();
			if(!e_DeviceController)
			{
